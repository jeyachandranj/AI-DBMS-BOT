            ...
            <div className="chatbotInput_container">
              <form onSubmit={(e) => e.preventDefault()} className="inputForm">
                  ...
                  <div className="microphoneIcon" onClick={toggleListening} >
                    <img src={mic} style={{ width: "100px", height: "100px", marginBottom: "50px" ,marginLeft:"200px" }} />
                  </div>
?
                  <input
                    value={speechText}
                    ...
                    style={{ color: "black",backgroundColor:"white", fontSize: "30px" ,marginLeft:"450px",width:"900px"}}
